...
window.GAME_RULES = [
  ...
  "双方随机决定先后手；先手第一回合获得 2 点行动点，后手第一回合获得 1 点行动点，并额外获得 1 张临时行动点卡（+1 行动点）。",
  "每回合行动点逐一上涨 1 点，上限 10 点。",
...
window.HERO_DEFS = {
  ...
  gojo: {
    ...
    passive: "若上回合结束时仍有未使用的行动点，则会将这些行动点转化为『无下限防御』。当本回合受到伤害时，先消耗该防御值抵挡伤害；若防御值不足，则剩余伤害扣血。",
    skills: [
      {
        no: 1,
        title: "普通攻击",
